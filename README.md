...
SourceDoc Pro is a free Windows utility that prints VB6 source code with syntax highlighting, loop bracket connectors, and procedure dependency reports for developer documentation and code review.
...
- Complete illustrated User Manual included
- Simple installer handles all setup automatically

## Requirements

- Windows 7 or later (32-bit or 64-bit)
- VB6 runtime (included in installer)

## Download

[Download SourceDocProSetup_v100.exe](https://github.com/MwC-GitHub/SourceDocPro/releases/download/v1.00/SourceDocProSetup_v100.exe)
...
If you find SourceDoc Pro useful, a voluntary donation to support continued development is appreciated:
